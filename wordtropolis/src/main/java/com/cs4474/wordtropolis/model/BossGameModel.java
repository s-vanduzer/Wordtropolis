...
public class BossGameModel {
    ...
    private void updateDifficulty() {
        if (wordsCompletedInPhase < 2) {
            currentDifficulty = Difficulty.EASY;
        } else if (wordsCompletedInPhase < 4) {
...
// Update advanceToNextWord to reset hint mode
    ...
    public int getMayorHealth() {
        return mayorHealth;
    }

    public int getMayorShield() {
        return mayorShield;
    }
    ...
    public int getMayorMaxHealth() {
        return MAYOR_MAX_HEALTH;
    }
    ...
    public int getWordsCompletedInPhase() {
        return wordsCompletedInPhase;
    }
