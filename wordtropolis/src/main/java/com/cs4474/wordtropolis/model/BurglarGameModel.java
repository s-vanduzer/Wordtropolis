...
/**
 * BurglarGameModel.java Manages word queue, letter pool, and game state for the
 * burglar chase game. The player must fill in missing letters in words to
 * advance the hero.
 */
public class BurglarGameModel {
    ...
    // ── Word Queue Building ───────────────────────────────────────────────────
    /**
     * Build the ordered word queue from the provided list. Converts each word
     * into a WordQuestion with missing letters.
     */
...
//        clean.sort(Comparator.comparingInt(String::length));
    ...
    /**
     * Create a WordQuestion from a full word. Randomly chooses which letters to
     * hide (2-3 letters for short words, more for longer).
     */
    ...
    /**
     * Build the available letters pool. Includes the missing letters plus
     * random distractors.
     */
    ...
    // ── Tile Actions ──────────────────────────────────────────────────────────
    /**
     * Select a letter from available pool. Called when player clicks a floating
     * letter tile.
     */
    ...
    // ── Answer Checking ───────────────────────────────────────────────────────
    /**
     * Check if the arrangement matches the missing letters in the exact order
     * required.
     */
    ...
    // ── Getters ───────────────────────────────────────────────────────────────
    public WordQuestion getCurrentQuestion() {
