 ...
 */
public final class CatSoundManager {
    ...
    private CatSoundManager() {}

    // ── Sound file name constants ─────────────────────────────────────────────
    /** Cat Meow — played on correct answer and rescue complete */
    public static final String SFX_MEOW_HAPPY    = "cat_meow.wav";

    /** Cat Meow-Mad — played when player gets the word wrong */
    public static final String SFX_MEOW_MAD      = "cat_meow_mad.wav";
    ...
    /** Wind Sound — played when difficulty increases to Medium or Hard */
    public static final String SFX_WIND           = "wind_sound.wav";
    ...
    public static final String BGM_BACKGROUND     = "background_music.wav";
    ...
    public static void startMusic() {
        ...
        try {
            URL res = CatSoundManager.class.getResource("/sounds/cat_game/" + BGM_BACKGROUND);
            if (res == null) {
                System.out.println("[CatSoundManager] BGM not found: " + BGM_BACKGROUND);
                return;
            }
            AudioInputStream ais = AudioSystem.getAudioInputStream(res);
