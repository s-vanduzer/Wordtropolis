...
public final class SoundManager {
    ...
    // ═══════════════════════════════ ONE-SHOT SFX ════════════════════════════
    /**
     * Play a sound effect once. Pass one of the constants above, e.g.
     * SoundManager.CAT_CORRECT File must be in resources/sounds/<filename>
     */
    ...
    // ═══════════════════════════════ BACKGROUND MUSIC ════════════════════════
    /**
     * Start looping background music. Fades out near the end of the track then
     * restarts smoothly.
     *
    ...
    // ═══════════════════════════════ VOLUME CONTROL ═══════════════════════════
    /**
     * Set SFX volume at runtime. Called by the settings/volume panel slider.
     *
    ...
    /**
     * Set music volume at runtime. Also updates the currently-playing BGM clip
     * immediately.
     *
     * @param v 0 (silent) to 100 (full)
     */
