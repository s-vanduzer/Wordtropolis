...
/**
 * ╔══════════════════════════════════════════════════════════╗ Wordtropolis –
 * Save the City! CS 4474 Group Project
 *
 * Entry point and screen router. Uses a single JFrame with CardLayout to swap
 * between panels.
 *
